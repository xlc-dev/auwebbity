...
export const WaveformView: Component<WaveformViewProps> = (props) => {
  ...
  return (
    <div class="w-full h-full relative flex flex-col items-center p-4 sm:p-6 md:p-8 overflow-hidden">
      <Show when={hasTracks()}>
        <div class="w-full max-w-[1200px] bg-[var(--color-bg-elevated)] border border-[var(--color-border)] rounded-lg relative flex flex-col h-full overflow-hidden">
          <div class="flex-1 overflow-x-auto overflow-y-hidden [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-[var(--color-bg)] [&::-webkit-scrollbar-track]:rounded [&::-webkit-scrollbar-thumb]:bg-[var(--color-border)] [&::-webkit-scrollbar-thumb]:rounded [&::-webkit-scrollbar-thumb]:border [&::-webkit-scrollbar-thumb]:border-[var(--color-bg)] [&::-webkit-scrollbar-thumb]:hover:bg-[var(--color-border-hover)]">
            <div class="flex flex-col">
              ...
              <div
                ref={containerRef}
                class="min-h-[200px] flex-shrink-0 [&_wave]:cursor-pointer [&_[data-name='cursor']]:!w-[3px] [&_[data-name='cursor']]:!bg-[#4a9eff] [&_[data-name='cursor']]:!z-[10] [&_[data-name='progress']]:!bg-[rgba(74,158,255,0.4)] [&>*]:overflow-visible [&_wave]:overflow-visible [&>*]:overflow-x-visible [&_wave]:overflow-x-visible"
              />
            </div>
          </div>
        </div>
      ...
      {!hasTracks() && (
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center text-[var(--color-text-secondary)] pointer-events-none text-sm sm:text-[0.9375rem] p-4 sm:p-6 md:p-8 opacity-70">
